...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-gradient-gold text-primary-foreground hover:shadow-gold-glow hover:brightness-110",
        ...
        hero: "bg-gradient-gold text-primary-foreground shadow-elegant hover:shadow-gold-glow hover:brightness-110 font-semibold tracking-wide",
        "outline-gold": "border-2 border-gold bg-transparent text-gold hover:bg-gold hover:text-primary-foreground",
        subtle: "bg-card text-foreground border border-border hover:border-primary/30 hover:shadow-elegant",
      },
      size: {
